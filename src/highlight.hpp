...
enum class Language {
    ...
    C, Cpp, Java, JavaScript, TypeScript, CSharp, Go, Rust, Kotlin, Scala,
    Swift, Dart, ObjectiveC, Php, Groovy, Zig, V, Nim, Crystal, D,

    // Hash-comment scripts
    Python, Ruby, Perl, R, Julia, Shell, PowerShell, Tcl,
    ...
    // Structured config
    Json, Json5, Yaml, Toml, Ini, Env, Properties,

    // Build / ops
    Makefile, Dockerfile, CMake, Nginx, Apache,

    // Other / misc text-like
    Diff, Patch, GitConfig, GitIgnore, VimScript, Markdown, Latex,
};
