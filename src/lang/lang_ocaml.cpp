...
const char* const KW_OCAML[] = {
    ...
    nullptr};
const char* const TY_OCAML[] = {"int",   "float", "string",    "char", "bool", "unit",
                                "list",  "array", "option",    "ref",  "exn",  "bytes",
                                "int32", "int64", "nativeint", nullptr};
const char* const BI_OCAML[] = {
    "true",         "false",     "None",          "Some",          "Ok",    "Error",
    "print_string", "print_int", "print_endline", "print_newline", "raise", "ignore",
    "ref",          "List",      "Array",         "String",        "Bytes", "Printf",
    "Format",       "Hashtbl",   "Map",           "Set",           nullptr};
...
const char* const KW_FS[] = {
    ...
    "sig",       "static", "struct", "then",     "to",      "true",      "try",      "type",
    "upcast",    "use",    "val",    "void",     "when",    "while",     "with",     "yield",
    nullptr};
const char* const TY_FS[] = {"int",    "int32", "int64", "float",   "float32", "double",
                             "string", "char",  "bool",  "unit",    "list",    "array",
                             "option", "seq",   "byte",  "sbyte",   "uint",    "uint32",
                             "uint64", "obj",   "exn",   "decimal", "void",    nullptr};
// reuse BI_OCAML mostly
const char* const BI_FS[] = {"true",    "false",  "None",    "Some",   "Ok",   "Error",
                             "printfn", "printf", "sprintf", "ignore", "ref",  "List",
                             "Array",   "Seq",    "Map",     "Set",    nullptr};
...
void tokenise_ocaml(std::string_view s, const TokenSink& e) {
    scan(s, e, OC);
}
void tokenise_fsharp(std::string_view s, const TokenSink& e) {
    scan(s, e, FS);
}
