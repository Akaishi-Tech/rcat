    ...
    if (s[i] == '0' && i + 1 < n) {
        ...
        if (p == 'x' || p == 'X') {
            ...
            if (i < n && (s[i] == 'p' || s[i] == 'P')) {
                ...
                if (i < n && (s[i] == '+' || s[i] == '-'))
                    ++i;
                while (i < n && (is_digit(s[i]) || s[i] == '_'))
                    ++i;
            }
            // suffix (u, l, ul, ull, L, f, ...)
            while (i < n && (is_alpha(s[i]) || s[i] == '_'))
                ++i;
            return i;
        }
        if (p == 'b' || p == 'B' || p == 'o' || p == 'O') {
