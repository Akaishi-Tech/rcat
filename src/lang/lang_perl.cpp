...
const char* const KW[] = {
    "and","cmp","continue","do","else","elsif","eq","exp","for","foreach","ge",
    "gt","if","last","le","local","lt","my","ne","next","no","not","or","our",
    "package","print","printf","redo","require","return","say","sub","unless",
    "until","use","when","while","xor","__END__","__DATA__","__FILE__","__LINE__",
    "__PACKAGE__",
    nullptr};
const char* const TY[] = {nullptr};
const char* const BI[] = {
    "abs","bless","chomp","chop","chr","close","defined","die","eval","exists",
    "grep","hex","int","join","keys","length","map","open","ord","pop","push",
    "ref","reverse","scalar","shift","sort","split","sprintf","sqrt","substr",
    "uc","ucfirst","undef","unshift","values","wantarray","warn",
    nullptr};
