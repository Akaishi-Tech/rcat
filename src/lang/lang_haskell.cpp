...
const char* const KW_HS[] = {
    "case","class","data","default","deriving","do","else","forall","foreign",
    "hiding","if","import","in","infix","infixl","infixr","instance","let",
    "module","newtype","of","qualified","then","type","where","_","family",
    nullptr};
const char* const TY_HS[] = {
    "Bool","Char","Double","Float","Int","Integer","String","Maybe","Either",
    "IO","Ordering","Word","ByteString","Text","Array",
    nullptr};
const char* const BI_HS[] = {
    "True","False","Nothing","Just","Left","Right","LT","EQ","GT","return",
    "putStrLn","putStr","print","read","show","map","filter","foldr","foldl",
    "head","tail","length","reverse","null","undefined","error",
    nullptr};

const char* const KW_ELM[] = {
    "as","case","else","exposing","if","import","in","let","module","of",
    "port","then","type","where","alias",
    nullptr};
const char* const TY_ELM[] = {
    "Bool","Char","Float","Int","String","List","Maybe","Result","Cmd","Sub",
    "Html","Attribute","Json","Decoder","Encoder",
    nullptr};
const char* const BI_ELM[] = {
    "True","False","Nothing","Just","Ok","Err","LT","EQ","GT","identity",
    nullptr};
...
const char* const KW_ADA[] = {
    ...
    "when","while","with","xor","true","false",
    nullptr};
...
void scan(std::string_view s, const TokenSink& emit, const Spec& sp) {
    ...
    while (i < n) {
        ...
        if (sp.dash_dash_line_comment && c == '-'
            && i + 1 < n && s[i + 1] == '-') {
...
void tokenise_haskell(std::string_view s, const TokenSink& e) { scan(s, e, HS);  }
void tokenise_elm    (std::string_view s, const TokenSink& e) { scan(s, e, ELM); }
void tokenise_ada    (std::string_view s, const TokenSink& e) { scan(s, e, ADA); }
